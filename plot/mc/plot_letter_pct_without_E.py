...
prop_gt_D = gt_stat_df['prop_gt_D'].iloc[1]
gt = pd.DataFrame(
	{
		'llm_name'     : ["Ground Truth"],
		'prop_A_without_E': [prop_gt_A],
		'prop_B_without_E': [prop_gt_B],
		'prop_C_without_E': [prop_gt_C],
		'prop_D_without_E': [prop_gt_D]
		}
	)
...
columns = ["prop_A_without_E", "prop_B_without_E", "prop_C_without_E", "prop_D_without_E"]
stat_df[columns] *= 100
